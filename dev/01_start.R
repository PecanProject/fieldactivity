...
## 
golem::fill_desc(
  pkg_name = "fieldactivity", # The Name of the package containing the App 
  pkg_title = "An app for keeping track of field activity", # The Title of the package containing the App 
